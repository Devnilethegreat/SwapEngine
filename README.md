# SwapEngine: Intelligent token swap routing with slippage minimisation AI Implementation
> Advanced javascript solution leveraging modern architecture patterns and cutting-edge AI technology.

SwapEngine aggregates liquidity from on-chain AMMs and off-chain RFQ systems, selecting the split route that minimises realised slippage using a learned market-impact model.
...
```bash
git clone https://github.com/Devnilethegreat/SwapEngine.git
cd SwapEngine
```
...
- **2025-05-10** — Expand test coverage for edge cases
- **2025-05-31** — Expand test coverage for edge cases
- **2025-06-05** — Expand test coverage for edge cases
